...
insert into track (track_name,diration,album_id)
values ('Intro',0.32, 1), ('A random act of kindness',4.14,1),('Disappearing',3.28,1),('Harlem river',9.16,2),('Slow train',5.51,2),
('Save our soul',4.54,5),('Nothing to save',3.18,5), ('Slow down',4.13,6), ('Grey monday',3.13,6),('Seat with me',4.28,6),('Pray to help',3.12,6),
('Sub Pielea Mea',4.08,7),('Aripile',3.32,8), ('Dragidtea',4.15,8),('Suna ma',3.39,8),('Rachete',4.15,8),('Zarplara',3.26,8)

insert into album_artist (album_id,artist_id) values (1,1),(2,1),(3,7),(4,7),(5,8),(6,8),(7,2),(8,2);
